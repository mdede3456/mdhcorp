...
<body>
    @foreach ($orders as $order)
        <div style="border: 2px solid black; margin:10px; padding:5px; " class="column">
            <table width="100%" border="0" cellspacing="0" font-size="12px;">
                <tbody>
                    <tr style="margin: 0; padding: 20px;">
                        <td style="margin: 0;" width="10%">
                            <img class="shop-logo" id="logo" src="{{ asset('img/logo.png') }}" style="height:60px;">
                        </td>
                    ...
                    <tr style="margin: 0; padding: 20px;">
                        <td colspan="4">
                            <p style="line-height: 1em;margin: 0;padding: 20px 0 0;" id="penerima">
                                <strong>Kepada <span
                    ...
                    <tr style="line-height: 1.25em;font-size: 12px;">
                        <td colspan="2">
                            <strong>
                                {{ $order->courier->name ?? '' }} | <b >{{ $order->courier_type }}</b> </strong>
                            <strong>
                                Ekspedisi
                            </strong>
                        </td>
                    ...
                    <tr >
                        ...
                        <td colspan="5">
                            <p style="font-size: 12px;line-height: 1.25em;margin:0;padding: 5px 0 10px;" id="alamat">
                                <span style="font-weight: bold; font-size:16px; text-transform: capitalize;">NOVI
