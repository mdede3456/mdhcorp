    ...
    <div class="section-body">
        <div class="row">
            ...
            @foreach ($orders as $order)
                ...
                {{-- SKIN PERTAMA --}}
                <div class="col-4 col-sm-12 col-lg-4 active_label" id="shipping_label">
                                ...
                                <div class="col-12">
                                    <div class="">
                                        <div class="row">
                                            <div class="col-7">
                                                <div class="author-box-name" id="nopo">
                                                    <a href="#">PO#{{ $order->id }}</a>
                                                </div>
                                                <div class="author-box-job" id="po_date">
                                                    {{ substr($order->created_at, 0, 10) }} </div>
                                        ...
                                        <div class="author-box-description">
                                            <p id="penerima"> <b>Kepada:</b> {{ $order->customer->name ?? '' }}
                                            </p>
                                        ...
                                        <div class="float-right  ">
                                            <a href="#" class="btn btn-info text-white"
                                                id="kurir">{{ $order->courier->name ?? '' }} | <b class=""
                                                    id="">{{ $order->courier_type }}</b></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                {{-- SKIN KEDUA --}}
                <div class="col-6 col-sm-12 col-lg-6 d-none" id="shipping_label_2">
                            ...
                            <table width="100%" border="0" cellspacing="0">
                                <tbody>
                                                        ...
                                                        <div>
                                                            <strong>
                                                                <span class="trigger-label-po-v2" id="nopo"
                                                                    style="font-size: 14px;">#{{ $order->id }}</span>
                                                            </strong>
                                                        </div>
                                                        <div>
                                                            <strong class="trigger-label-date-order-v2"
                                                                id="po_date">{{ substr($order->created_at, 0, 10) }}</strong>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="py bb-1" colspan="2" style="margin: 0; padding: 20px;">
                                            <span class="ls-1"><strong
                                                    id="penerima">{{ $order->customer->name ?? '' }}</strong></span> <br>
                                            <p id="alamat"> {{ $order->customer->user->address ?? '' }}</p>
                                    ...
                                    <tr class="trigger-label-order-detail-v2">
                                        <td class="py" colspan="3" style="margin: 0; padding: 20px;" id="product">
                                            ...
                                            @foreach ($order->items as $i)
                                                <?php $jumlahi += $i->qty; ?>
                                                <ul class="product-list trigger-label-product-list-v2 m-0">
                                ...
                                <tbody>
                                    <tr style="height: 90px">
                                        <td class="py bb-1 logo" colspan="2" style="margin: 0; padding: 10px;">
                                            <p align="center">
                                                <img align="center"
                                                    src="{{ asset('icon/couriers/' . $order->courier->code . '.svg') }}"
                                    ...
                                    <tr class="">
                                        <td class="bb-1" colspan="6" style="margin: 0; padding: 10px; ">
                                            <div class="" id="">
                                                <span>KEPADA:</span>
                                                <span id="penerima">{{ $order->customer->name ?? '' }}
                            ...
                            <table width="100%" border="0" cellspacing="0" font-size="12px;">
                                <tbody>
                                    <tr style="margin: 0; padding: 20px;">
                                        ...
                                        <td colspan="2" style="margin: 0;vertical-align: top;">
                                            <p id="po_date">
                                                ...
                                                <span
                                                    style="clear:both;display:block;font-weight: normal; margin-top:-5px;">{{ substr($order->created_at, 0, 10) }}</span>
                                            </p>
                                    ...
                                    @foreach ($order->items as $d)
                                        ...
                                        @endphp
                                        <tr style="font-size: 12px; vertical-align: middle; " id="product">
                                            <td colspan="2">
                                                {{ $d->product->name }}
                                            </td>
                                            <td>
